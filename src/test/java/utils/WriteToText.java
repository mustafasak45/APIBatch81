...
public class WriteToText {
    ...
    public static void saveSSNData(String fileName, GMIBankCustomer[] customers) {
        try {
    ...
    public static void saveEmailData(String fileName, GMIBankCustomer[] customers) {
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter(fileName, false));
    ...
    public static void saveCustomersData(String fileName, GMIBankCustomer[] customers) {
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter(fileName, false));
